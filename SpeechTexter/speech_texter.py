...
class Speech2Text:
    ...
    """
    def __init__(self,input_file,output_file, language_code, model_name, json_path=None) :
    ...
    def speech_to_text(self) -> str:
        ...
        if self.model_name == "google":
            ...
            try:
                transcribed_text = self.recognizer.recognize_google(audio_data, language=self.language_code)
